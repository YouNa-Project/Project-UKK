...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url() ?>assets/admin/img/icons/icon.png">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a href="<?= base_url() ?>home">Home</a></li>
          <li><a href="<?= base_url() ?>katalog">Our Menu</a></li>
          <li><a href="<?= base_url() ?>home/order">Order</a></li>
          <li><a href="<?= base_url() ?>pembayaran/cari">Pembayaran</a></li>
