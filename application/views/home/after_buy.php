                ...
                <?php foreach ($home as $item) { ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- The text field -->
                            <p class="card-text">1. Silahkan Untuk Melakukan Screenshot Kode dibawah ini dan Copy dan simpan. Kode ini digunakan untuk pencarian pada halaman pembayaran yang akan di lakukan di akhir :
                            <div class="row">
                                <div class="col-lg-5">
                            ...
                            <a href="<?= base_url() ?>/home/booking" class="btn btn-primary">Kembali Ke Halaman Awal</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
