            ...
            <div class="card">
                ...
                <div class="row m-2">
                    ...
                    <div class="col-md-5">
                        ...
                        <select class="select2bs4 form-control mb-2" id="id_menu" name="id_menu" required>
                ...
                <div class="col-lg-5">
                    <a href="<?= base_url() ?>pembayaran" class="btn btn btn-info shadow-sm mb-3"><i class="fas fa-arrow-left fa-sm text-white-50"></i> Kembali</a>
                ...
                <div class="col lg-12">
                    <div class="table-responsive">
                        <form method="POST" id="transaksi_form">
                            ...
                            <input type="hidden" name="total_harga_form" id="total_harga_form" value=""><br>
                            <div class="col-md-10">
                            <label style="font-weight: bold;">Notes</label>
                        <input type="text" id="notes" name="notes" class="form-control" placeholder="*Notes" required>
                                </div><br>
                        ...
                        <input type="text" id="cash" name="cash" class="form-control" placeholder="Cash" required>
                                </div>
                            <div class="col-md-30">
                            <label style="font-weight: bold;">Kembalian</label>
                        <input type="text" id="change" name="change" class="form-control" placeholder="Kembalian" required>
                                </div>
                            <br>
                            <button class="btn btn-sm btn-success shadow-sm" type="submit"><i class="fas fa-download fa-sm text-white-50"></i>Bayar & Cetak Transaksi</button>
                            </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    function HitungKembalian(){
        $total_belum_bayar = parseFloat(document.getElementById("total_harga_input").value);
        $cash = parseFloat(document.getElementById("cash").value);
        $change = $cash - $total_belum_bayar;
